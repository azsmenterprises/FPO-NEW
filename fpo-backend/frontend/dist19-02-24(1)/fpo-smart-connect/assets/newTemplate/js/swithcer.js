...
jQuery(document).ready(function(){		
	...
	jQuery('.dark').click(function(){	
		...
		jQuery(".national_emblem").attr("src","assets/images/handshakesymbol-removebg-preview.png");// high contrast
	...
	jQuery('.light').click(function(){	
		...
		jQuery(".national_emblem").attr("src","assets/images/handshakesymbol-removebg-preview.png"); //normal
