...
const services_data = [
{ name: "Why FPO", icon: "industries" },
{ name: "Registration", icon: "validation" },
{ name: "Search FPO", icon: "engineering" },
{ name: "About Us", icon: "management" },
{ name: "Schemes", icon: "manufacturing" },
{ name: "Important Link", icon: "technical" },
{ name: "Login", icon: "process" }];
