...
const services_data = [
{ name: "କାହିଁକି ଏଫ.ପି.ଓ", icon: "industries" },
{ name: "ନାମଲେଖା", icon: "validation" },
{ name: "ସନ୍ଧାନ କର", icon: "engineering" },
{ name: "ଏଫ.ପି.ଓ ବିଷୟରେ", icon: "management" },
{ name: "ଯୋଜନାଗୁଡିକ", icon: "manufacturing" },
{ name: "ଗୁରୁତ୍ୱପୂର୍ଣ୍ଣ ଲିଙ୍କ୍", icon: "technical" },
{ name: "ଲଗିନ", icon: "process" }];
