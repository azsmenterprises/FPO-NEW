    ...
    b.o = function() {
        ...
        this._touch = function(a) {
            var d = function(a) {
                ...
                b != c.cv && (c.cH && !1 === c.cH(b) || (c.change(c._validate(b)),
                c._draw()))
            };
    ...
    b.Dial = function() {
        ...
        this.val = function(a, b) {
            if (null == a)
                return this.v;
            a = this.o.parse(a),
            !1 !== b && a != this.v && this.rH && !1 === this.rH(a) || (this.cv = this.o.stopper ? c(d(a, this.o.max), this.o.min) : a,
            this.v = this.cv,
            this.$.val(this.o.format(this.v)),
            this._draw())
        }
        ...
        this.xy2val = function(a, b) {
            ...
            this.angleArc != this.PI2 && e < 0 && e > -.5 ? e = 0 : e < 0 && (e += this.PI2),
            f = e * (this.o.max - this.o.min) / this.angleArc + this.o.min,
        ...
        this.listen = function() {
            ...
            this.$.bind("keydown", function(b) {
                var e = b.keyCode;
                if (e >= 96 && e <= 105 && (e = b.keyCode = e - 48),
        ...
        this.arc = function(a) {
            var b, c;
            return a = this.angle(a),
            this.o.flip ? (b = this.endAngle + 1e-5,
            c = b - a - 1e-5) : (b = this.startAngle - 1e-5,
            c = b + a + 1e-5),
            this.o.cursor && (b = c - this.cursorExt) && (c += this.cursorExt),
            {
                s: b,
                e: c,
        ...
        this.draw = function() {
            ...
            "none" !== this.o.bgColor && (b.beginPath(),
            b.strokeStyle = this.o.bgColor,
            b.arc(this.xy, this.xy, this.radius, this.endAngle - 1e-5, this.startAngle + 1e-5, !0),
            b.stroke()),
            this.o.displayPrevious && (a = this.arc(this.v),
            b.beginPath(),
            b.strokeStyle = this.pColor,
            b.arc(this.xy, this.xy, this.radius, a.s, a.e, a.d),
            b.stroke(),
            d = this.cv == this.v),
            b.beginPath(),
            b.strokeStyle = d ? this.o.fgColor : this.fgColor,
            b.arc(this.xy, this.xy, this.radius, c.s, c.e, c.d),
            b.stroke()
        }
        ,
